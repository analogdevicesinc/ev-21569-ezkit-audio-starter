...
#define SOM_GET ss_get_21569_som
#define CRR_SET ss_set_somcrr_ezkit
#define SOM_SET ss_set_21569_som
...
static SS_PIN SS_PINS[] = {
    ...
    { .pinId = SS_PIN_ID_LED7, .get = SOM_GET, .set = SOM_SET},
    { .pinId = SS_PIN_ID_LED6, .get = SOM_GET, .set = SOM_SET},
